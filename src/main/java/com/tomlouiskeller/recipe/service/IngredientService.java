...
public class IngredientService {
    ...
    public Ingredient ingredientFactory(Double amount, String unitOfMeasurementName, String productName, Recipe recipe){
        ...
        Ingredient ingredient = new Ingredient(amount, unitOfMeasurement, product, recipe);
